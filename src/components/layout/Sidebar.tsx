...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { path: '/my-workout', name: 'Lịch Tập Của Tôi', icon: ClipboardCheck, roles: ['MEMBER'] },
        ...
        <nav className="space-y-2 px-4">
          {filteredMenu.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={`mr-3 h-5 w-5 ${isActive ? 'text-white' : 'text-slate-400 group-hover:text-sky-500'}`} />
