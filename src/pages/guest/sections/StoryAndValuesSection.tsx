    ...
    <section id="about" ref={containerRef} className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div 
            className="inline-block px-4 py-1.5 rounded-full bg-slate-100 text-slate-600 text-sm font-bold uppercase tracking-widest mb-6 gsap-animate"
          >
            Câu chuyện FitLife
          </div>
          <h2 
            className="text-4xl lg:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight gsap-animate"
          >
          ...
          <p 
            className="text-lg text-slate-600 leading-relaxed font-medium gsap-animate"
          >
        ...
        {/* Bento Grid Layout */}
        <div 
          className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto gsap-animate"
        >
          {/* Mission Card (Span 2 cols on md) */}
          <div className="md:col-span-2 bg-gradient-to-br from-slate-900 to-slate-800 p-8 lg:p-10 rounded-[2rem] text-white shadow-2xl relative overflow-hidden group gsap-animate">
          ...
          {/* Vision Card */}
          <div className="bg-sky-50 p-8 lg:p-10 rounded-[2rem] border border-sky-100 shadow-lg shadow-sky-100/50 hover:-translate-y-1 transition-transform gsap-animate">
          ...
          {values.map((val, idx) => (
            <div 
              key={idx} 
              className={cn("bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl transition-all group cursor-default gsap-animate", val.colSpan)}
            >
          ...
          {/* Extra Banner Card */}
          <div className="md:col-span-2 bg-emerald-500 p-8 lg:p-10 rounded-[2rem] text-white shadow-xl shadow-emerald-500/20 relative overflow-hidden group flex items-center justify-between gsap-animate">
