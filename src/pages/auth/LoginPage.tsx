...
export default function LoginPage() {
    ...
    return (
        <main
            ref={containerRef}
            className="relative h-screen w-full overflow-y-auto overflow-x-hidden bg-[url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=1470&auto=format&fit=crop')] bg-cover bg-center bg-fixed [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
        >
            ...
            <div className="relative z-10 grid min-h-screen w-full lg:grid-cols-2 py-10 lg:py-0">
              ...
              FitLife
                ...
                <section className="flex items-center justify-center p-4 lg:p-12">
                    <div
                        ref={formRef}
                        className="relative w-full max-w-md flex flex-col rounded-[2rem] border border-fit-border bg-white/95 p-8 shadow-auth lg:p-10"
                    >
