    ...
    return (
        <div className="space-y-4 max-w-4xl mx-auto">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">Thêm thiết bị mới</h1>
                    <p className="text-sm text-slate-500 mt-1">Nhập thông tin chi tiết cho thiết bị mới</p>
                </div>
            </div>
                                ...
                                <div className="flex items-center gap-4">
                                    <label className="flex flex-col items-center justify-center w-full h-20 border-2 border-dashed border-slate-200 hover:border-fit-primary rounded-lg cursor-pointer bg-slate-50 hover:bg-slate-50/50 transition-colors">
                                        <div className="flex flex-col items-center justify-center pt-2 pb-2">
                                            ...
                                            <p className="text-xs text-slate-500"><span className="font-semibold text-fit-primary">Nhập để tải lên</span> hoặc kéo thả</p>
